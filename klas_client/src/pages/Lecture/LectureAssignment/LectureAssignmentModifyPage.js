...
function LectureAssignmentModifyPage() {
        ...
        >
          <div class="flex flex-low justify-start w-full h-[10%] border border-black ">
            ...
            <input
              ...
              value={title}
              className="flex items-center border border-slate-300 justify-center w-[70%] placeholder:text-black"
              type="text"
              placeholder={title}
            />
            <div class="flex ml-4 mt-2 text-[20px]">
...
export default LectureAssignmentModifyPage;
