  ...
  return (
    <div className="flex flex-col justify-evenly items-center  h-screen bg-gradient-to-b from-white to-[#C8D6E8] ">
      ...
      {showForm === false ? (
        ...
        <div className="flex flex-col text-[15px]  w-[60%] h-[10%] border-[2px] items-center justify-between bg-white rounded-[10px">
          <div className="flex w-full pr-[10px]">글 제목:</div>
          <div>내용:</div>
        </div>
      )}
